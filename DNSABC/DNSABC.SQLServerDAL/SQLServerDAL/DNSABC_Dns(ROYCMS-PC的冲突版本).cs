...
namespace DNSABC.SQLServerDAL
{
	...
	public partial class DNSABC_Dns:IDNSABC_Dns
	{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,ProductID,UserID,Domain,PASSWORD,StartTime,EndTime,isHost,isTtl,isMonitor,isGroupID,State,Remark,UpdateTime,CreateTime ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,ProductID,UserID,Domain,PASSWORD,StartTime,EndTime,isHost,isTtl,isMonitor,isGroupID,State,Remark,UpdateTime,CreateTime ");
			strSql.Append(" FROM DNSABC_Dns ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
