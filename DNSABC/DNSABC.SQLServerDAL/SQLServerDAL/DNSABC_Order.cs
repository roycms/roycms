...
namespace DNSABC.SQLServerDAL
{
	...
	/// 数据访问类:DNSABC_Order
	/// </summary>
	public partial class DNSABC_Order:IDNSABC_Order
	{
		public DNSABC_Order()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "DNSABC_Order"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from DNSABC_Order");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DNSABC_Order ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
};
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM DNSABC_Order ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DNSABC_Order T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DNSABC_Order";
