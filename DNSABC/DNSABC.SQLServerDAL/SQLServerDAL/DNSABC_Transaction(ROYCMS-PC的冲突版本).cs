...
{
	/// <summary>
	/// 数据访问类:DNSABC_Transaction
	/// </summary>
	public partial class DNSABC_Transaction:IDNSABC_Transaction
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "DNSABC_Transaction"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from DNSABC_Transaction");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DNSABC_Transaction ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
};
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM DNSABC_Transaction ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DNSABC_Transaction T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DNSABC_Transaction";
