...
{
	/// <summary>
	/// 数据访问类:DNSABC_UserApi
	/// </summary>
	public partial class DNSABC_UserApi:IDNSABC_UserApi
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "DNSABC_UserApi"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from DNSABC_UserApi");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DNSABC_UserApi(");
			strSql.Append("Id,UserId,Ip,KEY)");
			strSql.Append(" values (");
			strSql.Append("@Id,@UserId,@Ip,@KEY)");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4),
					new SqlParameter("@UserId", SqlDbType.Int,4),
					new SqlParameter("@Ip", SqlDbType.VarChar,4000),
					new SqlParameter("@KEY", SqlDbType.VarChar,4000)};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DNSABC_UserApi set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DNSABC_UserApi ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)};
			parameters[0].Value = Id;
		...
		public DNSABC.Model.DNSABC_UserApi GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,UserId,Ip,KEY from DNSABC_UserApi ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)};
			parameters[0].Value = Id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,UserId,Ip,KEY ");
			strSql.Append(" FROM DNSABC_UserApi ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DNSABC_UserApi T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DNSABC_UserApi";
