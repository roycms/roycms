...
{
	/// <summary>
	/// 数据访问类:DNSABC_UserPerson
	/// </summary>
	public partial class DNSABC_UserPerson:IDNSABC_UserPerson
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "DNSABC_UserPerson"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from DNSABC_UserPerson");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DNSABC_UserPerson(");
			strSql.Append("UserId,Name,Position,Mobil,Tel,Qq,Email,Remark,UpdateTime,CreateTime)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DNSABC_UserPerson set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DNSABC_UserPerson ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
};
		...
		public DNSABC.Model.DNSABC_UserPerson GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,UserId,Name,Position,Mobil,Tel,Qq,Email,Remark,UpdateTime,CreateTime from DNSABC_UserPerson ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,UserId,Name,Position,Mobil,Tel,Qq,Email,Remark,UpdateTime,CreateTime ");
			strSql.Append(" FROM DNSABC_UserPerson ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,UserId,Name,Position,Mobil,Tel,Qq,Email,Remark,UpdateTime,CreateTime ");
			strSql.Append(" FROM DNSABC_UserPerson ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DNSABC_UserPerson T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DNSABC_UserPerson";
