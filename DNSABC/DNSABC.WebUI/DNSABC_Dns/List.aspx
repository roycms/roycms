<%@ Page Title="域名业务表 注意：N" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DNSABC.Web.DNSABC_Dns.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="StartTime" HeaderText="服务开始时间" SortExpression="StartTime" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="EndTime" HeaderText="服务结束时间" SortExpression="EndTime" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="isHost" HeaderText="主机个数 0表示主机个数不限制" SortExpression="isHost" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="isTtl" HeaderText="最小TTL值 0表示TTL值不限制" SortExpression="isTtl" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="isMonitor" HeaderText="宕机检测个数 0表示无宕机检测功能" SortExpression="isMonitor" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="isGroupID" HeaderText="服务器组ID 表示默认开通的服务器组" SortExpression="isGroupID" ItemStyle-HorizontalAlign="Center"  /> 
