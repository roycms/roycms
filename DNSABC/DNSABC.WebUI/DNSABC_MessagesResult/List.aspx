<%@ Page Title="消息回复表" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="DNSABC.Web.DNSABC_MessagesResult.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="MessagesID" HeaderText="消息ID" SortExpression="MessagesID" ItemStyle-HorizontalAlign="Center"  /> 
