...
namespace DNSABC.DALFactory
{
	...
	public sealed class DataAccess
	{
		...
		/// <summary>
		/// 创建ROYcms_user数据层接口。用户信息 用户表 R
		/// </summary>
		public static DNSABC.IDAL.IROYcms_user CreateROYcms_user()
		{

			string ClassNamespace = AssemblyPath +".ROYcms_user";
			object objType=CreateObject(AssemblyPath,ClassNamespace);
			return (DNSABC.IDAL.IROYcms_user)objType;
		}
