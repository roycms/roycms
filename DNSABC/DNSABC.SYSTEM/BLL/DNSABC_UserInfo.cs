...
namespace DNSABC.BLL
{
	...
	/// 用户信息扩展表
	/// </summary>
	public partial class DNSABC_UserInfo
	{
		private readonly IDNSABC_UserInfo dal=DataAccess.CreateDNSABC_UserInfo();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DNSABC.Model.DNSABC_UserInfo GetModelByCache(int Id)
		{
			
			string CacheKey = "DNSABC_UserInfoModel-" + Id;
			...
			return (DNSABC.Model.DNSABC_UserInfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DNSABC.Model.DNSABC_UserInfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DNSABC.Model.DNSABC_UserInfo> DataTableToList(DataTable dt)
		{
			List<DNSABC.Model.DNSABC_UserInfo> modelList = new List<DNSABC.Model.DNSABC_UserInfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DNSABC.Model.DNSABC_UserInfo model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new DNSABC.Model.DNSABC_UserInfo();
