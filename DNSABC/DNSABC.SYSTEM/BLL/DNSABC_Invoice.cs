...
namespace DNSABC.BLL
{
	...
	{
		private readonly IDNSABC_Invoice dal=DataAccess.CreateDNSABC_Invoice();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DNSABC.Model.DNSABC_Invoice GetModelByCache(int Id)
		{
			
			string CacheKey = "DNSABC_InvoiceModel-" + Id;
			...
			return (DNSABC.Model.DNSABC_Invoice)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DNSABC.Model.DNSABC_Invoice> GetModelList(string strWhere)
		{
