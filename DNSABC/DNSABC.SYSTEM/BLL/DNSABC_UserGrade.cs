...
namespace DNSABC.BLL
{
	...
	/// </summary>
	public partial class DNSABC_UserGrade
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DNSABC.Model.DNSABC_UserGrade GetModelByCache(int Id)
		{
			
			string CacheKey = "DNSABC_UserGradeModel-" + Id;
			...
			return (DNSABC.Model.DNSABC_UserGrade)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DNSABC.Model.DNSABC_UserGrade> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DNSABC.Model.DNSABC_UserGrade> DataTableToList(DataTable dt)
		{
			List<DNSABC.Model.DNSABC_UserGrade> modelList = new List<DNSABC.Model.DNSABC_UserGrade>();
