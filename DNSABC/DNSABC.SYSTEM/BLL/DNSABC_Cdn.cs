...
namespace DNSABC.BLL
{
	...
	{
		private readonly IDNSABC_Cdn dal=DataAccess.CreateDNSABC_Cdn();
		public DNSABC_Cdn()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public DNSABC.Model.DNSABC_Cdn GetModelByCache(int Id)
		{
			
			string CacheKey = "DNSABC_CdnModel-" + Id;
			...
			return (DNSABC.Model.DNSABC_Cdn)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DNSABC.Model.DNSABC_Cdn> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DNSABC.Model.DNSABC_Cdn> DataTableToList(DataTable dt)
		{
			List<DNSABC.Model.DNSABC_Cdn> modelList = new List<DNSABC.Model.DNSABC_Cdn>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DNSABC.Model.DNSABC_Cdn model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new DNSABC.Model.DNSABC_Cdn();
