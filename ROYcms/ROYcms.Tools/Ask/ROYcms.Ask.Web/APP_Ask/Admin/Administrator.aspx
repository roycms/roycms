<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Administrator.aspx.cs" Inherits="ROYcms.Ask.Web.APP_Ask.Admin.Administrator" ValidateRequest="false" %>
...
<div id="MainDiv">
    ...
    <table cellpadding="0" cellspacing="6" style="width: 600px; border: solid 1px #555555; background-color: #F0F0F0;">
      <tr>
        <td nowrap="nowrap"><p style="text-align: right;">问答首页标题</p></td>
