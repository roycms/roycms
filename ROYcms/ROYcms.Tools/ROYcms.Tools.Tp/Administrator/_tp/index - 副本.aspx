...
<div id="searchbar" class="w980">
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="410"><label>
            <input type="text" name="textfield" id="textfield" style="width:400px; height:19px; font-size:14px; border:solid 1px #ccc; background-color:#fff;cursor:text; padding-left:5px; padding-top:4px;" />
          </label></td>
        <td><label>
...
<div class="w980" style="margin-bottom:10px;">
  <div class="pd10">
    <div class="pinpailist BK">
      <h2><span class="ico_1"></span><span class="more"><a href="pinpai.html" target="_blank">更多金融服务行业品牌>></a></span>金融服务行业</h2>
      <div class="pinpai_index">
        ...
        <div class="pinpailist BK">
      <h2><span class="ico_1"></span><span class="more"><a href="pinpai.html" target="_blank">更多餐饮服务行业品牌>></a></span>餐饮服务行业</h2>
      <div class="pinpai_index">
        <ul>
