<%@ Page language="c#" Inherits="RewriterTester._Default" CodeFile="Default.aspx.cs" %>
...
<HTML>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<P>
				<asp:Button Runat="server" Text="View List Products" ID="Button1" onclick="Button1_Click"></asp:Button></P>
			<P>CategoryID:
