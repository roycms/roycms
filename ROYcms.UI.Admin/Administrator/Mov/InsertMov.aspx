<%@ Page Language="C#" AutoEventWireup="true" Inherits="ROYcms.UI.Admin.Administrator.MyShop.InsertGoods" %>
  ...
  <div id="rotate"> 
    ...
    <table width="100%" border="0" class="tiao_top">
      <tr>
        ...
        <a href='/administrator/mov/AdminMov.aspx?ClassKind=<%=ROYcms.Common.Request.GetQueryInt("ClassKind")%>'>
        <img align="absmiddle" src="/administrator/images/nv9.png" />返回视频列表</a> </div></td>
    ...
    <div class="content1" style="padding:0px; margin-top:3px;">
      <div class="layout">
        <table  cellSpacing="1" cellPadding="5" width="100%" border="0" bgcolor="#CCCCCC">
          <tr>
            <td width="11%" align="right" bgcolor="#F4FBFF"><strong>视频分类 </strong></td>
            ...
            <td width="56%" rowspan="5" valign="top" bgcolor="#F4FBFF"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                ...
                <tr>
                  <td><label>
                    <input name="is_real" type="checkbox" id="is_real" value="1" />
                  是否是实物</label></td>
                </tr>
                <tr>
                  <td><label>
          ...
          <tr>
            <td align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong>视频的唯一货号</strong></td>
            <td bgcolor="#F4FBFF">
          ...
          <tr>
            <td align="right" bgcolor="#F4FBFF"><strong>视频的名称</strong></td>
          ...
          <tr style="display:none">
            <td align="right" bgcolor="#F4FBFF"><strong>视频的重量</strong></td>
            <td colspan="2" bgcolor="#F4FBFF"><input type="text" name="goods_weight" id="goods_weight" class="txtInput" value="<%=Model.goods_weight %>"  />
            以千克为单位</td>
          </tr>
          <tr>
            <td align="right" bgcolor="#F4FBFF"><strong>视频关键字</strong></td>
            <td colspan="2" bgcolor="#F4FBFF"><input name="keywords" type="text" class="txtInput" id="keywords" size="60" value="<%=Model.keywords %>"  />
搜索引擎SEO备用</td>
          </tr>
          <tr>
            <td align="right" bgcolor="#F4FBFF"><strong>视频简短描述 </strong></td>
            <td colspan="2" bgcolor="#F4FBFF"><textarea name="goods_brief" cols="100" rows="3" id="goods_brief"><%=Model.goods_brief %></textarea></td>
          </tr>
         
          <tr >
            <td align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong>供货人姓名</strong></td>
            <td colspan="2" nowrap="nowrap" bgcolor="#F4FBFF"><input type="text" name="provider_name" id="provider_name" class="txtInput" value="<%=Model.provider_name %>"  />
备注该视频的供货商信息</td>
          </tr>
          <tr  style="display:none">
            <td align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong>视频的扩展属性</strong></td>
          ...
          <tr>
            <td align="right" bgcolor="#F4FBFF"><strong>视频报警数量</strong></td>
      ...
      <div class="layout">
            ...
            <table width="610" height="304"   cellSpacing="1" cellPadding="5" border="0" bgcolor="#CCCCCC">
              <tr>
                ...
                <a href="#" class="btnSearch" style=" padding:4px; margin-left:5px;"  id="GalleryListUpload"> 单独设置视频列表图片 </a>
                 <script>
			                       			KindEditor.ready(function(K) {
				                            var editor = K.editor({
                     ...
                     <!-- <a class="small_prev"></a><a class="small_next"></a>-->
                      <div id="pic_scroll" class="items" style="width:800px;">
                        <ul>
                         ...
                         <ItemTemplate> 
                          <li>
                          <a href="javascript:void(0)"><img bimg="<%#Eval("thumb_url")%>" src="<%#Eval("URL")%>" /></a>
                          </li>
                         </ItemTemplate>
                         </asp:Repeater>
                        </ul>
     ...
     <table width="100%"  cellSpacing="1" cellPadding="5" border="0" bgcolor="#CCCCCC">
              <tr>
                ...
                <a href="javascript:void(0)" class="btnSearch" style=" padding:4px;" id="AppendixUpload"> 选择添加视频文件到附件列表 </a>
                 ...
                 <asp:Repeater ID="Repeater_Appendix" runat="server">
                         <ItemTemplate> 
                          <div>
                                ...
                                附件名称：<%#Eval("Title")%>
                                附件地址：<%#Eval("URL")%>
                                <a href="javascript:void(0)" Rid="<%#Eval("Rid")%>" URL="<%#Eval("URL")%>">删除</a>
                          </div>
                         </ItemTemplate>
                 </asp:Repeater>
