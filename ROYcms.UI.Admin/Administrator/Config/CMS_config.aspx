    ...
    <td><a name="1" id="1"></a>
      ...
      <div class="content1" style="padding:0px; margin-top:2px;">
          ...
          <form id="ConfigIndexForm">
            <table   cellSpacing="1" cellPadding="5" width="100%" border="0" bgcolor="#CCCCCC">
              ...
              <tr>
                ...
                <td bgcolor="#F4FBFF">
                <textarea name="description" id="description" cols="65" rows="3"><CMS:WebConfig ID="WebConfig1" Name="description" runat=server /></textarea></td>
              </tr>
              <tr>
                <td align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong> 网站版权信息<br />
                </strong></td>
                <td bgcolor="#F4FBFF">
                <textarea name="copyright" id="copyright" cols="65" rows="3"><CMS:WebConfig ID="WebConfig2" Name="copyright" runat=server /></textarea></td>
              </tr>
            </table>
        ...
        <div class="layout">
          ...
          <table cellSpacing="1" cellPadding="5" width="100%" border="0" bgcolor="#CCCCCC">
            ...
            <tr>
              ...
              <td bgcolor="#F4FBFF"><textarea name="ucenter_menu" id="ucenter_menu" cols="60" rows="5"><CMS:WebConfig ID="WebConfig3" Name="ucenter_menu" Config="Ucenter.config" runat=server />
</textarea></td>
            </tr>
          </table>
          <div style="margin-top:5px;">
        ...
        <div class="layout">
         <form id="ConfigEmailForm">
          ...
          <div style="margin-top:5px;">
              ...
              <input type="reset" name="button2" id="Reset1" value="重置"  style="width:100px;" class="btnSubmit" >
          </div>
          </form>
        </div>
        <div class="layout">
          ...
          <table cellSpacing="1" cellPadding="5" width="100%" border="0" bgcolor="#CCCCCC">
            ...
            <tr>
             ...
             <tr>
              ...
              <td width="86%" bgcolor="#F4FBFF"><input name="qq_api" type="text" id="Text3" value='<CMS:WebConfig Name="qq_api" Config="OAuth.config" runat=server />' /></td>
            </tr>
            <tr>
              <td align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong>新浪微博密钥</strong></td>
              <td bgcolor="#F4FBFF"><input name="qq_key" type="text" id="Text4" value='<CMS:WebConfig Name="qq_key" Config="OAuth.config" runat=server />' /></td>
            </tr>
             <tr>
              <td width="14%" align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong>人人网登录api</strong></td>
              <td width="86%" bgcolor="#F4FBFF"><input name="qq_api" type="text" id="Text5" value='<CMS:WebConfig Name="qq_api" Config="OAuth.config" runat=server />' /></td>
            </tr>
            <tr>
              <td align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong>人人网登录密钥</strong></td>
              <td bgcolor="#F4FBFF"><input name="qq_key" type="text" id="Text6" value='<CMS:WebConfig Name="qq_key" Config="OAuth.config" runat=server />' /></td>
            </tr>
             <tr>
              <td width="14%" align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong>开心网登录api</strong></td>
              <td width="86%" bgcolor="#F4FBFF"><input name="qq_api" type="text" id="Text7" value='<CMS:WebConfig Name="qq_api" Config="OAuth.config" runat=server />' /></td>
            </tr>
            <tr>
              <td align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong>开心网登录密钥</strong></td>
              <td bgcolor="#F4FBFF"><input name="qq_key" type="text" id="Text8" value='<CMS:WebConfig Name="qq_key" Config="OAuth.config" runat=server />' /></td>
            </tr>
          </table>
          <div style="margin-top:5px;">
              <input name="config" type="hidden" id="Hidden1" value="OAuth.config">
              <input type="button" name="ConfigOAuthBT" id="ConfigOAuthBT" value="确认保存"  style="width:100px;" class="btnSubmit" >
              <input type="reset" name="button2" id="Reset2" value="重置"  style="width:100px;" class="btnSubmit" >
          </div>
       ...
       <div class="layout">
             ...
             <form id="ConfigStatisticsForm">
          <table cellSpacing="1" cellPadding="5" width="100%" border="0" bgcolor="#CCCCCC">
             <tr>
              <td width="14%" align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong>站长统计代码</strong></td>
              <td width="86%" bgcolor="#F4FBFF">
             
                  <textarea name="cnzz" id="cnzz" cols="65" rows="3"><CMS:WebConfig ID="WebConfig4" Name="cnzz" Config="ConfigStatistics.config" runat=server /></textarea>
               <span style="color:inherit" >统计申请地址：http://tongji.cnzz.com</span>
              </td>
                  </tr>
            <tr>
              <td align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong>51la统计代码</strong></td>
              <td bgcolor="#F4FBFF">
                    <textarea name="51la" id="51la" cols="65" rows="3"><CMS:WebConfig ID="WebConfig5" Name="51la" Config="ConfigStatistics.config" runat=server /></textarea>
            
                   <span style="color:inherit" >统计申请地址：http://www.51.la</span>
              </td>
            </tr>
               <tr>
              <td align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong>百度统计代码</strong></td>
              <td bgcolor="#F4FBFF">
                    <textarea name="baidu" id="baidu" cols="65" rows="3"><CMS:WebConfig ID="WebConfig6" Name="baidu" Config="ConfigStatistics.config" runat=server /></textarea>
            
                   <span style="color:inherit" >统计申请地址：http://www.baidu.com</span>
              </td>
            </tr>
          </table>
          <div style="margin-top:5px;">
              <input name="config" type="hidden" id="Hidden2" value="ConfigStatistics.config">
              <input type="button" name="ConfigStatisticsBT" id="ConfigStatisticsBT" value="确认保存"  style="width:100px;" class="btnSubmit" >
              <input type="reset" name="button2" id="Reset3" value="重置"  style="width:100px;" class="btnSubmit" >
          </div>
