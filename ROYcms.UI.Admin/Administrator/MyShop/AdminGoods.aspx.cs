...
{
    public partial class AdminGoods : ROYcms.AdminPage
    {
        ROYcms.Sys.BLL.ROYcms_Goods Bll = new Sys.BLL.ROYcms_Goods();
        /// <summary>
        ...
        void Bind()
        {
            ...
            where += " ClassKind= " + ROYcms.Common.Request.GetQueryInt("ClassKind");
