...
function AdminMain(){
   ...
   if(err!=null){alert(err);return}
	...
	////K.sync(".REditor");//同步所有编辑器数据 
		...
		$.ajax({
			   type: 'POST',
			   url: "/administrator/objet/AJAXInsert.aspx?random" + Math.random(),
...
function InsertReg(){
   ...
   if(err!=null){alert(err);return}
	editor.sync();//同步编辑器数据
		$.ajax({
			   type: 'POST',
			   url: "/administrator/CLASS/AJAXInsert.aspx?random" + Math.random(),
...
function CMSConfigAjax(objet){
   		$.ajax({
			   type: 'POST',
			   url: "/administrator/config/AJAXConfig.aspx?random" + Math.random(),
...
$(".Class_ModelBT").click(function(){
    $.ajax({
        url: "/administrator/Class/AJAXClass_Model.aspx?random" + Math.random(),
...
$("#NewHtmlBT").click(function(){
    $.ajax({
		   type: 'POST',
		   url: "/administrator/NewHtml/AJAXNewHtml.aspx?random" + Math.random(),
...
$("#InsertObjetBT").click(function(){
   ...
   if(err!=null){alert(err);return}
    $.ajax({
		   type: 'POST',
		   url: "/administrator/GO/AJAXAdd_objet.aspx?random" + Math.random(),
...
$("#InsertGoodsBT").click(function(){
   ...
   // if(err!=null){alert(err);return}
    $.ajax({
		   type: 'POST',
		   url: "/administrator/myshop/AJAXGoods.aspx?random" + Math.random(),
...
$("#InsertBrandBT").click(function(){
   ...
   // if(err!=null){alert(err);return}
    $.ajax({
		   type: 'POST',
		   url: "/administrator/myshop/AJAXBrand.aspx?random" + Math.random(),
