...
<Resources:Resources ID="Resources1" runat="server" />
   ...
   <td width="60%" align="left" nowrap>
               起始时间 <asp:TextBox ID="StarTime" runat="server" Width="80px"  CssClass="txtInput"></asp:TextBox>
               结束时间 <asp:TextBox ID="EndTime" runat="server" Width="80px"  CssClass="txtInput"></asp:TextBox>
            <script>
             ...
             <td>
                     ...
                     <asp:Button ID="btnSearch" CssClass="btnSearch" runat="server" Text="查询" OnClick="btnSearch_Click" />
             </td>
       </tr>
         ...
         <HeaderTemplate>
            <TABLE border=0 cellSpacing=1 cellPadding=5 width="100%"  class="Tb" >
                ...
                <TR id="tiao_center">
                  ...
                  <TD nowrap><span class="line">用户</span></TD>
          ...
          <ItemTemplate>
            <tr onMouseOver="this.style.background='#92C9D9'"  onmouseout="this.style.background='#f4fbff'">
              <td nowrap ><asp:CheckBox ID="ID_list" runat="server" />
              </td>
