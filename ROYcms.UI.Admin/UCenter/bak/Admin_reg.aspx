<%@ Page Language="C#" AutoEventWireup="true" Inherits="ROYcms.UCenter.Administrator_Enterprise_reg" Codebehind="Admin_reg.aspx.cs" %>


<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><%=config.web_name%> - 企业会员注册</title>
<style type="text/css">
<!--
.top {
	width: 750px;
...
<script src="../Administrator/WebUI/SpryAssets/SpryValidationPassword.js" type="text/javascript"></script>
<script src="../Administrator/WebUI/SpryAssets/SpryValidationConfirm.js" type="text/javascript"></script>
<script src="../Administrator/WebUI/SpryAssets/SpryValidationTextField.js" type="text/javascript"></script>
<link href="../Administrator/WebUI/SpryAssets/SpryValidationPassword.css" rel="stylesheet" type="text/css">
<link href="../Administrator/WebUI/SpryAssets/SpryValidationConfirm.css" rel="stylesheet" type="text/css">
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><div class="top">
      <div class="logo"><img name="" src='<%=config.logo %>' alt="ROYcms! NT" /></div>
      <div class="top_title"><strong>企业用户注册</strong><span><%=config.web_name%> - ROYcms NT!</span></div>
    </div></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0">
      <tr>
        <td width="55%" bgcolor="#E4E4E4">&nbsp;</td>
        <td width="26%" bgcolor="#E4E4E4" class="table_title">第一步：填写基本信息</td>
        <td width="14%" bgcolor="#E4E4E4" class="table_title">注册完成</td>
        </tr>
    </table></td>
  </tr>
</table>
<table width="750" height="404" border="0" align="center" cellpadding="4" cellspacing="1" bordercolor="#E1E1E1">
  <tr>
...
&nbsp;          <a href="login.aspx" title="我已经注册了账户，我要登录">我已注册了账户</a><br />
        </label>
  ...
  <tr>
    ...
    <td width="237" bgcolor="#F7F7F7" class="table_title">密码:<br />  
    ...
    <td width="243" bgcolor="#F7F7F7"  class="table_title">重复密码:<br />
    ...
    <td rowspan="7" valign="bottom" bgcolor="#F7F7F7" class="copy_right">信息发布平台</td>
  </tr>
  <tr>
    <td height="34" rowspan="2" bgcolor="#E4E4E4">&nbsp;</td>
    <td colspan="2" bgcolor="#F7F7F7" class="table_title"><span>最少6个字符,不超过14个字符(数字，字母和下划线)</span></td>
    </tr>
  <tr>
    <td bgcolor="#F7F7F7" class="table_title">
      
       机构名称:
      <span id="sprytextfield2">
        <label> <br />
          <input name="gs_name" type="text" id="GSname" size="30" maxlength="100" 
            runat="server" />
          <br>
        </label>
        <span class="textfieldRequiredMsg">请填写用户</span><span class="textfieldMaxCharsMsg">已超过最大字符数。</span><span class="textfieldMinCharsMsg">不符合最小字符数要求。</span></span>
      <span>汉字，(不能包含特殊字符)</span>
    ...
    <td bgcolor="#F7F7F7" class="table_title">电话号码:
      <span id="sprytextfield3">
      <label>
        <br />
        <input name="gs_tel" type="text" id="GStel" size="28" maxlength="100" 
            runat="server" />
        <br>
      </label>
      <span class="textfieldRequiredMsg">请填写用户</span><span class="textfieldMaxCharsMsg">已超过最大字符数。</span><span class="textfieldMinCharsMsg">不符合最小字符数要求。</span><span class="textfieldInvalidFormatMsg">电话格式无效。</span></span>
      <span>数字，(不能包含特殊字符)</span></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="#F7F7F7" class="table_title">
        <asp:Button ID="Button_add" runat="server" Text="同意以下条款并提交" 
            onclick="Button_add_Click" />  
        <a href="login.aspx" title="我已经注册了账户，我要登录"> 我已注册了账户</a></td>
    </tr>
  <tr>
    <td height="101" bgcolor="#E4E4E4">&nbsp;</td>
    <td colspan="2" bgcolor="#F7F7F7"><label>
      <textarea name="textarea" cols="65" rows="5" readonly="readonly" id="textarea">一、<%=config.web_name%>总则
...
　　 本网站（<%=config.web_host%>）所有的产品、技术与所有程序均属于知识产权，在此并未授权。
　　 “roycms”, “”及相关图形等为的注册商标。
...
<div class="copy_right"> <%=config.web_name %> 版权所有 ROYcms NT![中国家网]技术支持</div>
</form>
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "none", {maxChars:14, minChars:4});
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextfield2", "none", {maxChars:100, minChars:4});
