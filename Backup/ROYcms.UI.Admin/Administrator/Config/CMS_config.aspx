        ...
        <form id="ConfigPayForm">
          <table cellSpacing="1" cellPadding="5" width="100%" border="0" bgcolor="#CCCCCC">
            ...
            <tr>
              ...
              <td bgcolor="#F4FBFF"><input name="zhifubao_id" type="text" id="Text1" value='<CMS:WebConfig Name="zhifubao_id" Config="pay.config" runat=server />' /></td>
            </tr>
            <tr>
              <td align="right" nowrap="nowrap" bgcolor="#F4FBFF"><strong>支付宝Key</strong></td>
              <td bgcolor="#F4FBFF"><input name="zhifubao_key" type="text" id="Text1" value='<CMS:WebConfig Name="zhifubao_key" Config="pay.config" runat=server />' /></td>
            </tr>
          </table>
          <div style="margin-top:5px;">
