<%@ Page Language="C#" AutoEventWireup="true" Inherits="ROYcms.UI.Admin.Administrator.MyShop.AdminGoods" %>
...
<Resources:Resources ID="Resources1" runat="server" />
    <table width="100%" border="0" class="tiao_top">
      <tr>
        <td width="77%" nowrap>
        <div class="tiao_con">
        <a href="InsertMov.aspx?ClassKind=<%=ROYcms.Common.Request.GetQueryInt("ClassKind")%>" title="添加视频商品"><img align="absmiddle" src="/administrator/images/nv6.png" />添加视频商品</a> 
        </div>
        </td>
         ...
         <HeaderTemplate>
            <TABLE border=0 cellSpacing=1 cellPadding=5 width="100%"  class="Tb" >
                ...
                <tr id="tiao_center">
                  ...
                  <td width="28" nowrap="nowrap"><span class="line">视频货号</span></TD>
                  <td nowrap><span class="line">视频商品类别</span></TD>
                  <td nowrap><span class="line">视频商品名称</span></TD>
          ...
          <ItemTemplate>
            <tr onMouseOver="this.style.background='#92C9D9'"  onmouseout="this.style.background='#f4fbff'">
              ...
              <a href="InsertMov.aspx?Id=<%#Eval("Id") %>&Class=<%#Eval("goods_type") %>&Brand=<%#Eval("brand_id") %>&ClassKind=<%=ROYcms.Common.Request.GetQueryInt("ClassKind")%>" title='快捷编辑'>快捷编辑</a>
              | <a href="InsertMov.aspx?Id=<%#Eval("Id") %>&Class=<%#Eval("goods_type") %>&Brand=<%#Eval("brand_id") %>&ClassKind=<%=ROYcms.Common.Request.GetQueryInt("ClassKind")%>" title='编辑'>编辑</a>
