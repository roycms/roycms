     ...
     <asp:Repeater ID="rptMenuList" runat="server" OnItemDataBound="rptMenuList_ItemDataBound">               
            <HeaderTemplate>
             ...
             <ItemTemplate>
                ...
                <a rel="facebox" title="生成静态文件" href='/administrator/NewHtml/NewList.aspx?Id=<%#DataBinder.Eval(Container.DataItem,"Id") %>&ClassId=<%#DataBinder.Eval(Container.DataItem,"ClassId") %>&ClassKind=<% =ClassKind %>' > 生成</a> 
