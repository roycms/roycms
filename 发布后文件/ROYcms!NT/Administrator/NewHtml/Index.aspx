        ...
        <table  cellSpacing="1" cellPadding="5" width="100%" border="0" bgcolor="#CCCCCC">
          <tr>
            ...
            <td width="87%" height="25" align="left" bgcolor="#F4FBFF"><label>
                <input name="StaticHtmlType" type="checkbox" id="StaticHtmlType_0" style="vertical-align:middle;" value="0" checked="checked" />
                首页</label>
              <label>
                <input name="StaticHtmlType" type="checkbox" id="StaticHtmlType_1" style="vertical-align:middle;" value="1" checked="checked" />
                封面频道</label>
              <label>
                <input type="checkbox" name="StaticHtmlType" value="2" id="StaticHtmlType_2" style="vertical-align:middle;" />
                列表频道</label>
              <label>
                <input type="checkbox" name="StaticHtmlType" value="3" id="StaticHtmlType_3" style="vertical-align:middle;" />
                频道内文章</label></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="87%" height="25" align="left" bgcolor="#F4FBFF">
              <input type="text" name="ListCon" id="ListCon" class="txtInput" /></td>
          </tr>
          <tr>
            <td width="13%" height="25" align="right" bgcolor="#F4FBFF"><strong>生成文章数</strong></td>
            <td width="87%" height="25" align="left" bgcolor="#F4FBFF">
              <input type="text" name="ArticleCon" id="ArticleCon"  class="txtInput"  />
              （信息量较大时选择择一个有效的值可以降低生成的成本）</td>
          </tr>
          <tr>
