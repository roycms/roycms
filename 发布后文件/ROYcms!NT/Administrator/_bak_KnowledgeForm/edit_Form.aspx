<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_Form.aspx.cs" Inherits="ROYcms.UI.Admin.Administrator.knowledgeForm.edit_Form" %>
...
<body>
    ...
    <tr>
      <td height="25" colspan="2" align="left" nowrap="nowrap"><h3>编辑智能表单</h3></td>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <asp:Button ID="btnUpdate" runat="server" Text="确认编辑" OnClick="btnUpdate_Click" ></asp:Button>
      </td>
    </tr>
  </table>
    </div>
