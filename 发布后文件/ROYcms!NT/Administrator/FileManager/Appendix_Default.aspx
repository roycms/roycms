<%@ Page Language="C#" AutoEventWireup="true" Inherits="ROYcms.UI.Admin.Appendix_Default" Codebehind="Appendix_Default.aspx.cs" %>
...
.TBlist{ font-size:12px;
	font-family:Arial, Helvetica, sans-serif;
	margin-top:2px;
	color:#003f7b;
	border:1px solid #CCC;
	}
	.tiao_center{ background:url(../images/tiao_b.jpg) repeat-x; height:28px; font-size:12px; color:#FFF; font-size:12px; !important}
-->
</style></head>
<body>
<form id="form1" runat="server">
   ...
   <table width="100%" border="0" class="tiao_top">
              <tr>
                ...
                <a href="Appendix_Default.aspx"><img align="absmiddle" title="刷新" alt="刷新" src="/administrator/images/ico/refresh.gif" />刷新</a> 
   ...
   <div style="padding:5px; display:none"><strong>当前目录路径: </strong><asp:Label ID="lblCurrentPath" Font-Bold="true" runat="server" Font-Names="Verdana" Font-Size="12px"></asp:Label></div>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            <HeaderStyle Font-Bold="True" CssClass="tiao_center" ForeColor="#003f7b" />
        </asp:GridView>
    </div>
  <script type="text/javascript"> 
<!-- 
var returnVal; 
function MyCL(path,t)
	    {
	        returnVal = path;
	       //hidePopWin(false);
