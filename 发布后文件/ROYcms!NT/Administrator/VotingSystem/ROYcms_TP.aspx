                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><div class="barbg">
                        ...
                        <div style='WIDTH: <%# ny(Convert.ToInt32(Eval("ballot")))%>; background-image: url(SpryAssets/img/b<%# Container.ItemIndex>=10?(Container.ItemIndex-10):Container.ItemIndex%>.gif);  line-height: 20px;' class="l">
                            &nbsp;</div>
