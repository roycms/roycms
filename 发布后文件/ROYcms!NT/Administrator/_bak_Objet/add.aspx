<%@ Page Language="C#" AutoEventWireup="True" Inherits="ROYcms.UI.Admin.Administrator_Objet_add" ValidateRequest="false" EnableEventValidation="false" %>
...
<Resources:Resources ID="Resources1" runat="server" />
  <table width="100%" border="0" cellspacing="0" cellpadding="2">
    <tr>
      ...
      <table width="100%" border="0" cellpadding="5" cellspacing="0" style="margin-top:0px">
        <tr>
          <td  valign="top">
                    ...
                    <div class="TabbedPanelsContent">
                      <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#DFDFDF" id="add_table">
                        ...
                        <tr>
                          ...
                          <asp:TextBox ID="txttitle" runat="server" Width="400px" CssClass="input"></asp:TextBox>
                        ...
                        <tr >
                          ...
                          <td valign="top" bgcolor="#F4FBFF"><table width="500" border="0" cellpadding="3" cellspacing="0">
                            <tr>
                              <td nowrap>出处:
                          ...
                          <td align="center" valign="middle" nowrap bgcolor="#F4FBFF" width="35"><a href="#" title="点击关闭该项" id="_c1"><font color="#C2CCCC">X</font></a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td bgcolor="#F4FBFF"><asp:TextBox ID="txtzhaiyao" runat="server" Width="400px" 
                            ...
                            (可选)</td>
                          <td align="center" nowrap bgcolor="#F4FBFF"><a href="#" title="点击关闭该项"  id="_c3"><font color="#C2CCCC">X</font></a>
                            &nbsp;</td>
                        </tr>
                        <tr>
       ...
       function GET_IMG_pic(returnVal){document.getElementById("txtpic").value=returnVal; }
                        ...
                        <tr>
                          ...
                          <td bgcolor="#F4FBFF"><asp:TextBox ID="txttag" runat="server"   CssClass="input" Width="320px"></asp:TextBox>
                            <span class="_help">
                              <a class="submodal-460-360" href='tag.aspx?ClassKind=<%=this.ClassKind%>'><img src="/administrator/images/nv7.png" alt="选择可用TAG [每个标签请用英文的逗号隔开例“,”] (可选) " name="" width="16" height="16" border="0"> 选择可用TAG</a>
                              [每个标签请用英文的逗号隔开例“,”] </span>(可选) </td>
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top" nowrap bgcolor="#F4FBFF" class="_help"><label>
                            <input type="text" name="z_Url" id="z_Url" Class="input">
                            <input name="Z_url_clk" type="checkbox" id="Z_url_clk" value="0">
                            启用自定义静态生成地址</label></td>
                          <td align="center" valign="top" nowrap bgcolor="#F4FBFF" class="_help">&nbsp;</td>
                        </tr>
                        <tr>
                          <td align="left" valign="top" nowrap bgcolor="#F4FBFF">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp; &nbsp;内容↓
                            ： &nbsp;</td>
                        ...
                        <tr>
                          <td colspan="3" align="left" valign="top" nowrap bgcolor="#F4FBFF">
                          
                          <FCKeditorV2:FCKeditor ID="FCKeditor1" runat="server" EditorAreaCSS="/App_Templet/SystemCss/FckCss.css" BasePath="../FCKedit/" Height="400px" ToolbarSet="ROY" Width="100%" Value=""></FCKeditorV2:FCKeditor></td>
                        </tr>
                        <tr>
                          <td height="50" colspan="3" align="left" nowrap bgcolor="#F4FBFF">&nbsp;
                            ...
                            &nbsp; &nbsp;<span class="_help">(发布参考/注意事项)</span></td>
                        </tr>
                      </table>
                    </div>
                    <div class="TabbedPanelsContent">
