...
namespace ROYcms.Sys.BLL
{
	...
	{
		private readonly ROYcms.Sys.DAL.ROYcms_Order dal=new ROYcms.Sys.DAL.ROYcms_Order();
		public ROYcms_Order()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ROYcms.Sys.Model.ROYcms_Order GetModelByCache(int Id)
		{
			
			string CacheKey = "ROYcms_OrderModel-" + Id;
			...
			return (ROYcms.Sys.Model.ROYcms_Order)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ROYcms.Sys.Model.ROYcms_Order> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<ROYcms.Sys.Model.ROYcms_Order> DataTableToList(DataTable dt)
		{
			List<ROYcms.Sys.Model.ROYcms_Order> modelList = new List<ROYcms.Sys.Model.ROYcms_Order>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				ROYcms.Sys.Model.ROYcms_Order model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new ROYcms.Sys.Model.ROYcms_Order();
