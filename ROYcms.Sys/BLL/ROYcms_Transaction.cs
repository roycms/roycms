...
namespace ROYcms.Sys.BLL
{
	...
	{
		private readonly ROYcms.Sys.DAL.ROYcms_Transaction dal=new ROYcms.Sys.DAL.ROYcms_Transaction();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public ROYcms.Sys.Model.ROYcms_Transaction GetModelByCache(int Id)
		{
			
			string CacheKey = "ROYcms_TransactionModel-" + Id;
			...
			return (ROYcms.Sys.Model.ROYcms_Transaction)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<ROYcms.Sys.Model.ROYcms_Transaction> GetModelList(string strWhere)
		{
