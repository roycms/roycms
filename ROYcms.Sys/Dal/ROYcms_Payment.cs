...
namespace ROYcms.Sys.DAL
{
    ...
    public partial class ROYcms_Payment
    {
        ...
        public bool Exists(int Id)
        {
            ...
            strSql.Append("select count(1) from ROYcms_Payment");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into ROYcms_Payment(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ROYcms_Payment set ");
        ...
        public bool Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from ROYcms_Payment ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
};
        ...
        public ROYcms.Sys.Model.ROYcms_Payment GetModel(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,UserID,PaymentType,PaymentName,PaymentAmount,PaymentNum,UpdateTime,CreateTime from ROYcms_Payment ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
};
            ...
            ROYcms.Sys.Model.ROYcms_Payment model = new ROYcms.Sys.Model.ROYcms_Payment();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM ROYcms_Payment ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from ROYcms_Payment T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "ROYcms_Payment";
