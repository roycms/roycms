...
namespace ROYcms.Sys.DAL
{
    ...
    public partial class ROYcms_Invoice
    {
        ...
        public int GetFieldCount(string Field, string strWhere)
        {
            ...
            strSql.Append("select SUM(" + Field + ") FROM ROYcms_Invoice ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from ROYcms_Invoice");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into ROYcms_Invoice(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ROYcms_Invoice set ");
        ...
        public bool Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from ROYcms_Invoice ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
};
        ...
        public ROYcms.Sys.Model.ROYcms_Invoice GetModel(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,UserID,InvoiceName,Price,PostType,RealName,Tel,Mobil,Address,PostCode,Remark,State,AdminRemark,CreateTime from ROYcms_Invoice ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
};
            ...
            ROYcms.Sys.Model.ROYcms_Invoice model = new ROYcms.Sys.Model.ROYcms_Invoice();
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM ROYcms_Invoice ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from ROYcms_Invoice T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "ROYcms_Invoice";
