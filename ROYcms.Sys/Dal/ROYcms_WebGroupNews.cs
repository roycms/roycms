...
namespace ROYcms.Sys.DAL
{
    ...
    public class ROYcms_WebGroupNews
    {
        ...
        //public int GetMaxId()
        //{
        //    return DbHelperSQL.GetMaxID("bh", ""+PubConstant.date_prefix+"WebGroupNews");
        //}
        /// <summary>
        /// 是否存在该记录
        /// </summary>
        public bool Exists(int bh)
        {
            ...
            strSql.Append("select count(1) from "+PubConstant.date_prefix+"WebGroupNews");
        ...
        /// <summary>
        /// 获取一条信息 条件 Tops the WebGroupNews.
        /// </summary>
        /// <returns></returns>
        public ROYcms.Sys.Model.ROYcms_WebGroupNews TopNews(string where)
        {
            ...
            strSql.Append(" FROM [" + PubConstant.date_prefix + "WebGroupNews] ");
            if (where.Trim() != "")
            {
                strSql.Append(" where " + where);
            }

            ROYcms.Sys.Model.ROYcms_WebGroupNews model = new ROYcms.Sys.Model.ROYcms_WebGroupNews();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select title from " + PubConstant.date_prefix + "WebGroupNews");
            strSql.Append(" where bh=@bh ");
            SqlParameter[] parameters = {
					new SqlParameter("@bh", SqlDbType.Int,4)};
            parameters[0].Value = bh;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + Field + " from " + PubConstant.date_prefix + "WebGroupNews");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select type from " + PubConstant.date_prefix + "WebGroupNews");
            strSql.Append(" where bh=@bh ");
            SqlParameter[] parameters = {
					new SqlParameter("@bh", SqlDbType.Int,4)};
            parameters[0].Value = bh;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select classname from " + PubConstant.date_prefix + "WebGroupNews");
            strSql.Append(" where bh=@bh ");
            SqlParameter[] parameters = {
					new SqlParameter("@bh", SqlDbType.Int,4)};
            parameters[0].Value = bh;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update "+PubConstant.date_prefix+"WebGroupNews set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into "+PubConstant.date_prefix+"WebGroupNews(");
        ...
        public void Delete(int bh)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete "+PubConstant.date_prefix+"WebGroupNews ");
            strSql.Append(" where bh=@bh ");
            SqlParameter[] parameters = {
					new SqlParameter("@bh", SqlDbType.Int,4)};
            parameters[0].Value = bh;
        ...
        public ROYcms.Sys.Model.ROYcms_WebGroupNews GetModel(int bh)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 * from "+PubConstant.date_prefix+"WebGroupNews ");
            strSql.Append(" where bh=@bh ");
            SqlParameter[] parameters = {
					new SqlParameter("@bh", SqlDbType.Int,4)};
            parameters[0].Value = bh;
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = ""+PubConstant.date_prefix+"WebGroupNews";
