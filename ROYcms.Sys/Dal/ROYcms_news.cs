...
namespace ROYcms.Sys.DAL
{
    ...
    public class ROYcms_news
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from " + PubConstant.date_prefix + "news");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + Field + " from " + PubConstant.date_prefix + "news");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select type from " + PubConstant.date_prefix + "news");
            strSql.Append(" where bh=@bh ");
            SqlParameter[] parameters = {
					new SqlParameter("@bh", SqlDbType.Int,4)};
            parameters[0].Value = bh;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select classname from " + PubConstant.date_prefix + "news");
            strSql.Append(" where bh=@bh ");
            SqlParameter[] parameters = {
					new SqlParameter("@bh", SqlDbType.Int,4)};
            parameters[0].Value = bh;
        ...
        public void Delete(int bh)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete " + PubConstant.date_prefix + "news ");
            strSql.Append(" where bh=@bh ");
            SqlParameter[] parameters = {
					new SqlParameter("@bh", SqlDbType.Int,4)};
            parameters[0].Value = bh;
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder, string TableName)
        {
            ...
            strSql.Append(" * ");
            strSql.Append(" FROM " + PubConstant.date_prefix + "news, " + TableName);
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + PubConstant.date_prefix + "news.bh = " + TableName + ".Id AND " + strWhere);
            }
            strSql.Append(" order by " + filedOrder);
            return ROYcms.DB.DbHelpers.GetDataSet(strSql.ToString());
        }
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, int OrderType)
        {
            ...
            parameters[0].Value = "" + PubConstant.date_prefix + "news";
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, int OrderType, string OrderName)
        {
            ...
            return DbHelperSQL.RunProcedure("ROYcms_New_Page", parameters, "ds");
        }
        /// <summary>
        /// 分页获取数据列表
        /// </summary>
